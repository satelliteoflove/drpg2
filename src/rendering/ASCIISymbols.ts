...
export const SYMBOL_CATEGORIES = {
  ENVIRONMENT: [
    'WALL', 'FLOOR', 'DOOR_CLOSED', 'DOOR_OPEN', 'STAIRS_UP', 'STAIRS_DOWN', 'CHEST'
  ],
  ENTITIES: [
    'PLAYER', 'MONSTER_WEAK', 'MONSTER_MEDIUM', 'MONSTER_STRONG', 'MONSTER_BOSS'
  ],
  ITEMS: [
    'ITEM_WEAPON', 'ITEM_ARMOR', 'ITEM_POTION', 'ITEM_SCROLL', 'ITEM_GOLD'
  ],
  UI: [
    'BORDER_HORIZONTAL', 'BORDER_VERTICAL', 'MENU_CURSOR', 'HEALTH_FULL', 'MANA_FULL'
  ],
  STATUS: [
    'STATUS_OK', 'STATUS_POISON', 'STATUS_SLEEP', 'STATUS_DEAD'
  ]
} as const;
...
export class SymbolUtils {
  ...
  public static getSymbolColor(key: ASCIISymbolKey): typeof SYMBOL_COLORS[keyof typeof SYMBOL_COLORS] | null {
