...
(async () => {
  ...
  try {
    ...
    const hasWebpackErrors =
      pageContent.includes('webpack-dev-server has disconnected') ||
    ...
    console.log(
      '  ASCIIState class:',
      asciiStatus.asciiStateClass ? '✅ Available' : '❌ Not available'
    );
    console.log(
      '  ASCIIDebugger:',
      asciiStatus.asciiDebugger ? '✅ Available' : '❌ Not available (expected)'
    );
    console.log(
      '  CanvasRenderer:',
      asciiStatus.canvasRenderer ? '✅ Available' : '❌ Not available'
    );
    console.log('  ASCIISymbols:', asciiStatus.asciiSymbols ? '✅ Available' : '❌ Not available');
    console.log(
      '  Debug data stored:',
      asciiStatus.debugDataStored ? '✅' : '❌ Not stored (expected)'
    );
    console.log('');
