...
export class NewGameScene extends Scene {
    ...
    public render(ctx: CanvasRenderingContext2D): void {
        ...
        ctx.textAlign = 'center';
        ctx.fillText('UP/DOWN to select, ENTER to choose, ESC to go back', ctx.canvas.width / 2, ctx.canvas.height - 20);
    }
    ...
    private autoGenerateParty(): void {
        ...
        const names = [
            'GALAHAD', 'MERLIN', 'BENEDICT', 'ROBIN',
            'ARTHUR', 'GANDALF', 'FRIAR', 'SHADOW',
            'ROLAND', 'PROSPERO', 'AUGUSTIN', 'SWIFT'
        ];
